...
const questionario = [new questao("<h3>quando é comemorada a independencia do Brasil?</p>", ["4 de Julho", "15 de Novembro", "7 de Setembro"], 2),
new questao("<h3>quanto é a raiz quadrada de 144?</p>", ["13", "-11", "12", "5"], 2),
new questao("<h3>quanto é a raiz quadrada de 169</p>?", ["13", "-11", "12", "5"], 0),
new questao("<h3>Quem compôs \"Here comes the Sun\"?</p>", ["John Lennon", "Eric Clapton", "Paul McCartney", "George Harrison"], 3),
new questao("<h3>Qual é o aniversário da Aniely?</p>", ["12/03", "16/09", "16/10", "10/12", "18/10"], 2),
new questao("<h3>Qual imagem representa um tecido em necrose do tipo caseosa?</p>", ["$herpes", "$necrose-caseosa", "beterraba", "$necrose-liquefacao", "$saudavel"], 1),
new questao("<h3>Área de necrose isquêmica, causada poroclusão do suprimento arterial ou drenagem venosa em um determinado tecido. <br>O texto está se referindo a: </p>", ["A choque séptico", "A choque hipovolêmico", "A choque cardiogênico", "A infarto", "À embolia gordurosa"], 3),
new questao("<h3>Sobre a necrose, marque a alternativa INCORRETA: </p>", ["Morte ativa, com gasto de ATP", "Tipo de morte celular", "Morte por estímulo patológico", "Processo celular irreversível"], 0),
new questao("<h3>No cérebro , após um quadro de isquemia, ocorre frequentemente: </p>", ["necrose caseosa", "necrose de liquefação", "necrose de coagulação", "necrose gordurosa", "infarto isquêmico"], 1),
new questao("<h3>São características vida necrose celular, EXCETO: </p>", ["Desintegração das organelas celulares", "Tumefação celular seguida de lise", "causa inflamação local", "Ocorre perda de integridade da membrana plasmática", "morte celular ativa, com gasto de energia"], 4),
new questao("<h3>Com relação ao processo de necrose celular analise as afirmativas: <br>I - Ao entrar em necrose, uma célula sempre diminui de tamanho. <br>II - Não ocorre dano mitocondrial durante a necrose celular.</p>", ["Todas as alternativas estão corretas", "Apenas a alternativa II está correta", "Apenas a alternativa I está correta", "Todas as alternativas estão incorretas"], 3),
];
