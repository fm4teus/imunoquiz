...
const questionario = [new questao("quando é comemorada a independencia do Brasil?",
["4 de Julho", "15 de Novembro", "7 de Setembro"], 2),
    new questao("quanto é a raiz quadrada de 144?",
["13", "-11", "12", "5"], 2),
    new questao("quanto é a raiz quadrada de 169?",
["13", "-11", "12", "5"], 0),
    new questao("Quem compôs \"Here comes the Sun\"?",
["John Lennon", "Eric Clapton", "Paul McCartney", "George Harrison"], 3),
    new questao("Qual é o aniversário da Aniely?",
["12/03", "16/09", "16/10", "10/12", "18/10"], 2),
    new questao("Qual imagem representa um tecido em necrose do tipo caseosa?",
["$herpes", "$necrose-caseosa", "$necrose-gangrena", "$necrose-liquefacao", "$saudavel"], 1),
...
["Choque séptico", "Choque hipovolêmico", "Choque cardiogênico", "Infarto", "Embolia gordurosa"], 3),
    new questao("Sobre a necrose, marque a alternativa INCORRETA: ",
["Morte ativa, com gasto de ATP", "Tipo de morte celular", "Morte por estímulo patológico", "Processo celular irreversível"], 0),
    new questao("No cérebro , após um quadro de isquemia, ocorre frequentemente: ",
["necrose caseosa", "necrose de liquefação", "necrose de coagulação", "necrose gordurosa", "infarto isquêmico"], 1),
    new questao("São características vida necrose celular, EXCETO: ",
["Desintegração das organelas celulares", "Tumefação celular seguida de lise", "causa inflamação local", "Ocorre perda de integridade da membrana plasmática", "morte celular ativa, com gasto de energia"], 4),
...
["Todas as alternativas estão corretas", "Apenas a alternativa II está correta", "Apenas a alternativa I está correta", "Todas as alternativas estão incorretas"], 3),
...
["caseosa", "gomosa", "de coagulação", "de liquefação", "por gangrena"], 3),
    new questao("Sobre apoptose qual alternativa está incorreta? ",
["Muitas células ao chegar ao fim de seu período de funcionalidade, entram em apoptose.", "Apoptose é uma morte celular programada.", "A apoptose protege células vizinhas de danos.", "O sinal que desencadeia apoptose é proveniente de outras células."], 3),
